...
public class C01_Ogretmen {
    ...
    */
    ...
    int tecrubeYil;
    static String okul;
    public C01_Ogretmen(String isim,int tecrubeYil){//tlescopic constructor
        this.isim=isim;
        this.tecrubeYil=tecrubeYil;
    }
    public static void maasHesapla(){
        System.out.println("Maaşınızı güle güle harcayın");
    }
    public void evlilikYildonumu(){
        System.out.println("evlilik yıldönümünüz kutlu olsun!");
    }

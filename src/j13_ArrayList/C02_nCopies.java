...
public class C02_nCopies {
    public static void main(String[] args) {
        ...
        ArrayList<String> ulkelist = new ArrayList<>(Arrays.asList("Almanya", "Küba", "Polonya", "İngiltere", "Amerika"));//çuval
        ...
        System.out.println("eklenmeden önce ulkelist = " + ulkelist);//[Almanya, Küba, Polonya, ingiltere, Amerika]
        ulkelist.addAll(isimList);//ulkelistin sonuna isimList elemanlarının tamamı eklendi
        System.out.println("eklenmeden sonra ulkelist = " + ulkelist);//

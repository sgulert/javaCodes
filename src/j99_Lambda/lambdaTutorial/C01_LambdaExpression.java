...
public class C01_LambdaExpression {
    ...
    */
    public static void main(String[] args) {
        ...
        printStructered(sayiList);
        printFunctional(sayiList);
        yazdir(a);
    ...
    //task01->"Structured Programming"--> AMELE Programming kullanara list elemanlarını aynı satırda
    // aralarında bosluk olacak şekilde print ediniz.

    public static void printStructered(List<Integer> sayiList){
    ...
    public static void printFunctional(List<Integer> sayiList){

 ...
 */
        HashSet<String> hs1= new HashSet<>();//boş hashset
        HashSet<String> hs2= new HashSet<>(Arrays.asList("javatar", "javacan","javasu","javFer"));
        //set print
        ...
        System.out.println("hs2.contains(\"javacan\") = " + hs2.contains("javacan"));

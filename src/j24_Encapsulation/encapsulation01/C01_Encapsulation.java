...
public class C01_Encapsulation {
    ...
    */
    public static void main(String[] args) {
        ...
        obj1.name="Ali Osman";
        System.out.println("obj1.mailver() = " + obj1.getMail());
        //private olduu için ulaşamadığımız variablelara method create ederek erişebiliriz.//sadece erişim, set etme yok.

        obj1.name="ismail";//encapsulated  edilmeyen variable'a obj ile erişilip update edilebilir. o yüzden dikkatli olmak ya da private yapmak lazım.
